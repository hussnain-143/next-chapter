...
exports.getRecommendations = exports.detectWeakTopics = exports.chatWithAI = exports.generateProjectSuggestions = exports.generatePracticeTasks = exports.summarizeLesson = exports.generateInterviewQuestions = exports.generateCodingChallenge = exports.generateFlashcards = exports.generateQuiz = void 0;
...
const generateFlashcards = async (lessonContent, lessonTitle) => {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
...
const generateCodingChallenge = async (lessonContent, lessonTitle) => {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
...
exports.generateCodingChallenge = generateCodingChallenge;
const generateInterviewQuestions = async (lessonContent, lessonTitle) => {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
...
const summarizeLesson = async (lessonContent, lessonTitle) => {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
...
const generatePracticeTasks = async (lessonContent, lessonTitle) => {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
...
exports.generatePracticeTasks = generatePracticeTasks;
const generateProjectSuggestions = async (subjectName, lessons) => {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
...
exports.generateProjectSuggestions = generateProjectSuggestions;
...
const detectWeakTopics = async (lessons) => {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
...
exports.detectWeakTopics = detectWeakTopics;
const getRecommendations = async (completedLessons, currentSubjects, weakTopics) => {
    const response = await openai.chat.completions.create({
        model: 'gpt-4o-mini',
        messages: [
            {
